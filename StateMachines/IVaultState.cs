namespace InnoVault.StateMachines
{
    ...
    public interface IVaultState<TContext>
    {
        ...
        /// 但仅<b>服务端</b>返回非<see langword="null"/>且不同于当前状态的实例时才会真正发生状态切换（<see cref="VaultStateMachine{TContext}.ServerAuthoritative"/>默认为<see langword="true"/>）
        /// </summary>
        /// <param name="machine">驱动该状态的状态机实例</param>
        /// <param name="ctx">状态所处的上下文实例</param>
        /// <returns>返回非<see langword="null"/>表示请求切换到该新状态；返回<see langword="null"/>表示保持当前状态</returns>
