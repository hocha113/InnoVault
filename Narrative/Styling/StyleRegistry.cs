...
namespace InnoVault.Narrative.Styling
{
    ...
    public static class StyleRegistry
    {
        ...
        public static void RegisterSet(string modName, string styleName, DialogueSkin dialogue = null, ChoiceSkin choice = null, PopupSkin popup = null)
            => RegisterSet(StyleId.ForMod(modName, styleName), dialogue, choice, popup);
