...
namespace InnoVault.GameContent.BaseProjectile
{
    /// <summary>
    /// 手持武器的基本类，定义了基本的手持行为，与网络接口
    /// </summary>
    public class BaseHeldProj : ModProjectile
    {
        #region Data
        ...
        /// <summary>
        /// 更新在AI函数之前，返回<see langword="false"/>阻止后续逻辑运行
        /// </summary>
        /// <returns></returns>
